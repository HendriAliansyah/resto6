...
mixin _$AppUser {
  ...
  int get hashCode => Object.hash(runtimeType, uid, email, displayName,
      restaurantId, role, isDisabled, sessionToken, fcmToken);

  @override
  String toString() {
    return 'AppUser(uid: $uid, email: $email, displayName: $displayName, restaurantId: $restaurantId, role: $role, isDisabled: $isDisabled, sessionToken: $sessionToken, fcmToken: $fcmToken)';
  }
}
